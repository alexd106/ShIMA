...
Useers can download the example datasets in the Examples directory under the ShIMA at Github (https://github.com/alexd106/ShIMA/tree/master/Examples/Examples.zip). Download the Examples.zip file and extract it in your local system.
...
The .mzXML files have been grouped into "blank", "QC", "sample1", "sample2" and "sample3" and put inside directories with the respective names (Fig-1a). Each of the directories contains 4 .mzXML files.
