...
Number of metabolites with high confidence: length(unique(Res[Res$Confidence == 3,]$chemical_ID))

Number of metabolites with medium confidence: length(unique(Res[Res$Confidence == 2,]$chemical_ID))

Number of metabolites with low confidence: length(unique(Res[Res$Confidence == 1,]$chemical_ID))

Number of metabolites with no confidence: length(unique(Res[Res$Confidence == 0,]$chemical_ID))
